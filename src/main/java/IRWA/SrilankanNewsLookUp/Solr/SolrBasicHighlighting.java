...
public class SolrBasicHighlighting {
	...
	private static final String PRE_TEXT = "<h3>";

	private static final String POST_TEXT = "</h3>";
	...
	public static void main(String[] args) throws SolrServerException, IOException {
		...
		query.set(CommonParams.Q, SolrConstant.heading + ":\"Special Cabinet meeting ends\"");
		...
		query.addHighlightField(SolrConstant.heading);
